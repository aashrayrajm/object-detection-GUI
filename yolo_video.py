...
while True:
	...
	if writer is None:
		...
		writer = cv2.VideoWriter('output_files/video_output.avi', fourcc, 30,
	...
	cv2.putText(frame, object_count, (10, 15),
                            cv2.FONT_HERSHEY_COMPLEX_SMALL, 0.8, (0, 0, 0), 2)
	cv2.putText(frame, str(counting_each_object(labels)), (10, 32),
                            cv2.FONT_HERSHEY_COMPLEX_SMALL, 0.8, (0, 0, 0), 2)
	writer.write(frame)
